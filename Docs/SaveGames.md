...
Choose **Play → Single → New Game** to create a named career, or **Continue** beside an existing career. Each career has independent money, contract completion, grades, rewards and handbook progress.
...
- The successful PlayFab login result supplies the player ID. The save picker displays this ID. Account identity and display options remain global; gameplay preferences use `GameSavePrefs` while a career is selected.
