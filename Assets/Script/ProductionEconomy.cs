...
public static class ProductionEconomy
{
    ...
    public const int Prop = 250, Wall = 500, Vehicle = 2500, LightStrip = 900, Megaphone = 900, ActorBase = 750;
    ...
    public static int EquipmentPrice(string name, int fallback)
    {
        ...
        if (item.Contains("MEGAPHONE") || item.Contains("BULLHORN")) return Megaphone;
        return fallback;
    }
}
